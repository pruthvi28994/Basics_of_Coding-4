...
public class java_StringBuilderEx1 {
	...
	public static void main(String[] args) {
		...
		sb4.append(" sagar s");
		//if old SB is increased from its current stringb then size is increase by (oldcapcity*2)+2
		System.out.println(sb4.capacity());
		
		//ensureCapacity(10) ensures that the given capacity is minimum to the current capacity 
